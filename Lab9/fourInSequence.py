# TODO: Student writes their name and the date they started their work at the top of the file in the comment block below. 
...
# TODO: Student turns in their assignment before the 11:59 p.m. deadline and the file is named fourInSequence.py
#       (DELETE this TODO line before turning in)
...
def checkForNextMoveWin(board, playerNumber):
    ...
    #       (KEEP this TODO/ HINT/ NOTE line block until everything is completed and working)
...
def checkAdjacent(board, playerNumber):
    ...
    # TODO: Write code in this function that accomplishes the specification outlined in the documentation comment above.
    #       (KEEP this TODO/ HINT/ NOTE block until completed)
    # HINT: Each comment below represents a single line of code at the appropriate indentation level.
    # HINT: Do not start with this function - start with the checkWinner() function and get that working in 2 player mode.
    # HINT: You have been given the code to check the first adjacent piece - you will need to check all the other adjacent pieces.
    # NOTE: You do not need to do this according to the comments below - you may do this however you wish.
